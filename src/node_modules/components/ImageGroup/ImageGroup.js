...
class ImageGroup extends Component {
  ...
  renderOne() {
    ...
    return (<div style={style} onClick={() => this.imageClicked(str1)}></div>)
  ...
  renderTwo() {
    ...
    let style1 = {width: '100%', height: '50%',
                  backgroundImage: `url(${str1})`,
                  backgroundSize: 'cover',
                  backgroundRepeat: 'no-repeat',
                  cursor: 'pointer'}

    let style2 = {width: '100%', height: '50%',
    ...
    return (<div style={{width: '100%', height: '100%'}}>
              <div style={style1} onClick={() => this.imageClicked(str1)}></div>
              <div style={style2} onClick={() => this.imageClicked(str2)}></div>
            </div>)
  ...
  renderThree() {
    ...
    let style1 = {width: '50%', height: '100%',
                  backgroundImage: `url(${str1})`,
                  backgroundSize: 'cover',
                  backgroundRepeat: 'no-repeat',
                  cursor: 'pointer'}
    ...
    let style3 = {width: '100%', height: '50%',
    ...
    return (<div style={{width: '100%', height: '100%', display: 'flex', flexDirection: 'row'}}>
              ...
              <div style={{display: 'flex', flexDirection: 'column', width: '50%', height: '100%'}}>
                <div style={style2} onClick={() => this.imageClicked(str2)}></div>
                <div style={style3} onClick={() => this.imageClicked(str3)}></div>
              </div>
            </div>)
  ...
  renderFour() {
    ...
    let style4 = {width: '100%', height: '50%',
    ...
    return (<div style={{width: '100%', height: '100%', display: 'flex', flexDirection: 'row'}}>
              ...
              <div style={{display: 'flex', flexDirection: 'column', width: '50%', height: '100%'}}>
                <div style={style3} onClick={() => this.imageClicked(str3)}></div>
                <div style={style4} onClick={() => this.imageClicked(str4)}></div>
              </div>
            </div>)
  ...
  render() {
    ...
    let mainStyle = {width: this.state.width, height: this.state.height,
